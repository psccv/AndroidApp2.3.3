...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(MainActivity.this, "액티비티 생성", Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        super.onStart();
        Toast.makeText(MainActivity.this, "액티비티 시작", Toast.LENGTH_SHORT).show();
    }

    @Override
    protected void onStop() {
        super.onStop();
        Toast.makeText(MainActivity.this, "액티비티 정지", Toast.LENGTH_SHORT).show();
    }
    ...
    protected void onDestroy() {
        ...
        super.onDestroy();
        Toast.makeText(MainActivity.this, "프로그램 종료", Toast.LENGTH_SHORT).show();
        finish();//액티비티 화면 종료
